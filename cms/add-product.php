...
<body>
                    ...
                    <div style="padding: 50px 120px">
                        ...
                        <div class="grid grid-cols-2">
                            <div>
                                ...
                                <h1 class="color1 font-plusjkt-bold">Add New Product</h1>
                                ...
                                <div class="form-tr">
                                    ...
                                    <a href="#" style="margin-top: 35px"
                                        class="btn-circle bg-color1 text-color-white font-plusjkt-semi submit-tour">Submit
                                        Product</a>
                                </div>
                            ...
                            <div style="margin-top: 45px">
                                ...
                                <div class="form-tr">
                                    ...
                                    <a href="#" class="file-upload" id="upload-trigger">
                                        <img src="image/btn-upload.svg" alt="">
                                    </a>
                                    ...
                                    <textarea class="textarea-forms" style="height: 300px !important"
                                        id="input-desc"></textarea>

                                    <!-- <p class="font-inter-medium"
                                        style="color: #979797; font-size: 13px; margin-top: 35px">
                                        Highlights</p>

                                    <textarea class="textarea-forms" id="input-hg"></textarea>

                                    <p class="font-inter-medium"
                                        style="color: #979797; font-size: 13px; margin-top: 44px">
                                        Booking Policy</p>

                                    <textarea class="textarea-forms" id="input-bp"></textarea>

                                    <p class="font-inter-medium"
                                        style="color: #979797; font-size: 13px; margin-top: 35px">
                                        Itinerary</p>

                                    <textarea class="textarea-forms" id="input-iti"></textarea> -->
    ...
    <script type="text/javascript" src="js/page-products.js"></script>
</body>
